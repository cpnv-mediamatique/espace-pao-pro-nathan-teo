...
<body classe="container align-items-center" style="font-family:Open Sans;">
  ...
  <main style="padding-bottom:6vw;">
    ...
    <div class="col-12 container">
      <h2 class="" style="color:#01A659;">Casiers pour mobile</h1>
    </div>
    <div class="container">
      <div class="row g-2">
        <div class="col-3">
          <div class="col-2">
            <button type="button" class="p-3 btn btn-link"><img src="img/Casier/Casier01.jpg" style="width: 20vw"></button>
          </div>
        </div>
      </div>
    </div>
    <div class="container">
      <div class="d-flex justify-content-end">
        <form action="commande/achat.php?id=2" method="post">
          <div class="d-flex justify-content-end">
            <div>
              <input type="number" id="tentacles" name="tentacles" min="10" max="50" required>
