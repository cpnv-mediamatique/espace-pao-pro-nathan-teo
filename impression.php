...
<body classe="container align-items-center" style="font-family:Open Sans;">
  ...
  <main style="padding-bottom:6vw;">
    <div class="col-12 container">
      <h1 class=" display-3" style="color:#01A659; font-weight: 500; padding-top:2em;">Impression</h1>
    </div>
    <div class="col-12 container">
    ...
    <div class="col-12 container">
      <h2 class="" style="color:#01A659;">Choix du type de format</h1>
    </div>
    <div class="container">
      <div class="row g-2">
        <div class="col-3">
          <div class="col-2">
            <button type="button" class="p-3 btn btn-link"><img src="img/Impression/Imprimer02.jpg" style="width: 20vw"></button>
          </div>
        </div>
        <div class="col-3">
          <div class="col-2">
            <button type="button" class="p-3 btn btn-link"><img src="img/Impression/Imprimer03.jpg" style="width: 20vw"></button>
          </div>
        </div>
      </div>
      <div class="col-12 container">
        <h2 class="" style="color:#01A659;">Choix du grammage</h1>
      </div>
      <div>
        <input type="number" id="tentacles" name="tentacles" min="80" max="400" step="5">

      </div>
      <div class="col-5">
        <label class="form-label" for="customFile">Insérez votre impression</label>
