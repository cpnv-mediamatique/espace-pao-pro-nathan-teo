...
<body classe="container align-items-center" style="font-family:Open Sans;">
  ...
  <main style="padding-bottom:6vw;">
    <div class="col-12 container">
      <h1 class=" display-3" style="color:#01A659; font-weight: 500; padding-top:2em;">Etiquettes</h1>
    </div>
    <div class="col-12 container" style="padding-bottom:2em;">
    ...
    <div class="col-12 container">
      <h2 class="" style="color:#01A659;">Choix du type d'étiquettes</h1>
        <p class="">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque tincidunt, lorem at interdum eleifend, turpis dui rhoncus tellus, quis fermentum metus justo in elit. Suspendisse varius viverra nisi aliquet pulvinar. Aliquam sollicitudin accumsan sapien ac maximus. Praesent at justo congue ligula porta hendrerit quis vitae leo. Donec at lorem porta, tincidunt eros sollicitudin, fermentum arcu. Nunc a commodo eros. Cras eu dolor mollis, aliquet tellus eget, accumsan mauris. Aenean eu iaculis massa. Suspendisse volutpat semper mi vitae elementum. </p>
    </div>
    <div class="container">
      <div class="row g-2">
        <div class="col-3">
          <div class="col-2">
            <button type="button" class="p-3 btn btn-link"><img src="img/Etiquette/Etiquette01.jpg" style="width: 20vw"></button>
          </div>
        </div>
        <div class="col-3">
          <div class="col-2">
            <button type="button" class="p-3 btn btn-link"><img src="img/Etiquette/Etiquette02.jpg" style="width: 20vw"></button>
          </div>
        </div>
      </div>
    </div>
    <div class="container">
      <div class="d-flex justify-content-end">
        <form action="commande/achat.php?id=3" method="post">
          <div class="d-flex justify-content-end">
            <div>
              <input type="number" id="tentacles" name="tentacles" min="10" max="100" step="10" required>
