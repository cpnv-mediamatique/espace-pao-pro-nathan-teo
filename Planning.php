...
<body classe="container align-items-center" style="font-family:Open Sans;">
  ...
  <main style="padding-bottom:6vw;">
    <div class="col-12 container">
      <h1 class=" display-3" style="color:#01A659; font-weight: 500; padding-top:2em;">Plannings de nettoyages</h1>
    </div>
    <div class="col-12 container">
    ...
    <div class="col-12 container">
      <h2 class="" style="color:#01A659;">Plannings de nettoyages</h1>
    </div>
    <div class="container">
      <div class="row g-2">
        <div class="col-3">
          <div class="col-2">
            <button type="button" class="p-3 btn btn-link"><img src="img//Planning/Planning.jpg" style="width: 20vw"></button>
          </div>
        </div>
      </div>
    </div>
    <div class="container">
      <div class="d-flex justify-content-end">
        <form action="commande/achat.php?id=4" method="post">
          <div class="d-flex justify-content-end">
            <div>
              <input type="number" id="tentacles" name="tentacles" max="5" required>
