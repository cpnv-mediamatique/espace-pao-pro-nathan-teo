...
<body classe="container" style="font-family:Open Sans;">
  <div class="border d-flex align-items-center justify-content-end" style="height: 100vh;">
    ...
    <form class="col-md-5">
      <b>Votre message à bien été envoyé !</b>
      <p>Nous allons vous répondre le plus rapidement possible.</p>
      <div class="mb-2 col-md-9">
        <a class="btn text-white col-md-6" href="PageConnection.php" style="background-color:#01A659; font-weight: bold;">
